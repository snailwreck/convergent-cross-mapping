...
with tab1:
    ...
    ax_embed.set_xlabel('Z(t)')
    ax_embed.set_ylabel(f'Z(t + {tau})')
    ax_embed.set_zlabel(f'Z(t + {2*tau})')
    ax_embed.set_title("3D Delay Reconstructed Phase Space from Z")
    st.pyplot(fig_embed)
    plt.close(fig_embed)
